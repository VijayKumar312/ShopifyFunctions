...
export function run(input) {
  ...
  let toRename = input.cart.deliveryGroups
    ...
    .filter(
      (group) => group.deliveryAddress?.provinceCode && group.deliveryAddress.provinceCode == 'NC',
    )
  ...
  let update_attribute = input.cart.deliveryGroups.deliveryAddress.zip;
  ...
  return {
    operations: [toRename, update_attribute],
  };
}
